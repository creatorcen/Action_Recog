...
# parser.add_argument('data', metavar='DIR1', default='./datasets/UCF-101',
#                     help='path to dataset')
# parser.add_argument('data', default='./datasets/UCF-101', metavar='DIR11',
#                     help='path to dataset')

parser.add_argument('--settings', metavar='DIR', default='./datasets/settings',
                    help='path to datset setting files')

# parser.add_argument('--data', default='./datasets/ucf101data/rgb_data/jpegs_256', metavar='DIR110',
#                     help='path to dataset')
parser.add_argument('--data', default='./datasets/frame_and_flow', metavar='DIR',
                    help='path to dataset')

parser.add_argument('--modality', '-m', metavar='MODALITY', default='rgb',
                    choices=["rgb", "flow"],
                    help='modality: rgb | flow')
parser.add_argument('--dataset', '-d', default='smcity',
                    choices=["ucf101", "hmdb51","smcity"],
                    help='dataset: ucf101 | hmdb51|smcity')
...
parser.add_argument('--epochs', default=1599, type=int, metavar='N',
                    help='number of total epochs to run')
...
parser.add_argument('--lr_steps', default=[100, 200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400], type=float, nargs="+",
...
def main():
    ...
    train_dataset = datasets.__dict__[args.dataset](root=args.data,    #neet to change
...
def build_model():
    ...
    model = models.__dict__[args.arch](pretrained=True, num_classes=90)
    model.cuda()
    return model
...
def adjust_learning_rate(optimizer, epoch):
    ...
    decay = 0.95 ** (sum(epoch >= np.array(args.lr_steps)))
    lr = args.lr * decay
